...
def set_file_indent(file):
    # This code breaks in 2030 and.or after we assign 1 million CDBs per year
    file_name = os.path.basename(file)

    # We match the years 2021 through 2029, 1 million and up so that's guaranteed CDB space only
    # CDB bot uses 2 space for indent
    ...
    #
    if re.match("CDB-202[1-9]-1[0-9][0-9][0-9][0-9][0-9][0-9]", file_name):
        indent = 2
    else:
        indent = 4
    return(indent)
